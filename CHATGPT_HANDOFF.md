...
**Test baseline**: 2086 passed, 1 skipped, 12 deselected (live tests)
...
**Implement Location Slice 4 (Location-scoped reference management, resolution, generation preview, per-shot readiness) on `p4-operator-workflow`.**

Slices 1-3 complete. Slice 3: Location CRUD API (5 endpoints), Scene Location assignment with outdated propagation, Location description staleness (36 tests). 2086 total passed. See `docs/ROADMAP.md` for the complete 7-slice plan.
