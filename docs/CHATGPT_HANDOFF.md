...
| Deterministic tests | 1238 passed, 9 live deselected, 0 failed |
...
**M6.C:** COMPLETE — QueueWorker (atomic claim, execute, recovery), GenerationService.generate_take evolution, max_attempts=1, 18 tests.
